...
25. fork - ссылка находится на сервере GIThub и предназначена для того чтобы можно была зайти в чужую (предворительно найденную) работу и выполнить в ней какието изменения (дополнения).
